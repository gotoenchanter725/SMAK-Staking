<template>
  <div class="top-gainers pt-8">
    <h3 class="top-gainers__title px-6">Top gainers 24h</h3>
...
export default class TopGainers extends Vue {
  ...
  async beforeMount() {
    ...
    const result = await this.query("https://smartlink-indexer-api.deployments.smart-chain.fr/v1/top/gainers")
  ...
  //   ],
  //   fees: { direction: EItemDirection.UP, value: 500 },
  //   tvl: { direction: EItemDirection.UP, value: 3_450_000 },
  //   liquidity: { direction: EItemDirection.UP, value: 200 },
  // })
}
</script>
